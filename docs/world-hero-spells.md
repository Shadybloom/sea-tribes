...
* +++ "Огненный снаряд" (Fire_Bolt) — поджигает предметы. В мире много соломенных крыш, а в вашем отряде кувшинов с горючим маслом. Впрочем, с тем же успехом можно использовать флягу алхимического огня с пращей, или обмотанную тряпицей стрелу.
...
* ??? "Booming_Blade) — скорее всего бесполезно. У нас бой в плотном строю, манёвров мало. А если использовать в поединке с командиром, то он, скорее всего, отступая, не свалится от единственного удара.
* "Леденящее прикосновение" (Chill_Touch) — запрещает лечение на один раунд, но это бесполезно. Если командир нуждается в лечении, он отступает за спины своих бойцов, так получая полное укрытие от взгляда мага.
...
* +++ "Щит" (Shield) — без него не выжить. Вышедший впереди строя маг рискует получить десятки дротиков и стрел, а с заклинанием "Shield" и "Mage_Armor" ранить его смогут разве что случайно. Единственный вариант, что ему собьют реакцию. Но способных на это противников не так уж и много, герои 3+ lvl все не пересчёт.
...
**Боевые заклинания (сделай, испытай):**  
* "Опутывающий удра" (Ensnaring_Strike) — опутывание и 1d6 урона в начале хода врага. Пока не вырвется. Это атака мечом/стрелой.  
...
## 3 lvl — заклинания волшебника/чародея/варлока/барда (1 волшебник 3+ lvl на 160 000 населения)
...
* "Притворная смерть" (Feign Death) — может оно и полезно. Но едва ли для тех, кто ведёт в бой армии.
...
* "Водное дыхание" (Water_Breathing) — это ритуальное заклинание, очень ценное для ваших бойцов. Использовать тяжёлые доспехи в абордажном бою чертовски опасно, но с водным дыханием они могут ничего не бояться. Да и груз с затопленного корабля всегда можно будет поднять.
...
Water_Walk — абордажники в тяжёлых доспехах скажут вам спасибо.
