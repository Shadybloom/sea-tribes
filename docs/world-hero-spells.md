...
В сотне крупнейших городов мира есть "Круги телепортации", а поддерживают их 50 волшебников, бардов и чародеев 9+ lvl. В нашем регионе два таких города, это Иллирийский Эрагвейт и кошачий Коттаям.
...
- **Телепортационные перевозки**. Годовой поток пассажиров — от 0.25 до 2 млн. человек. Стоимость "билета" от 0.05 до 0.2 эфеса (до максимума в 5 эфесов за личный телепорт). Объём переносимых ими грузов (в сумках/корзинах) — от 12 000 кубометров до 100 000 кубометров. В основном это всё та же почта, мелкие товары и личные вещи.
    ...
    - Пример: Перевозка алхимического огня "Потайными сундуками".
...
* "Чудо-ягоды" (Goodberry) — аптечки. За день до боя 12 друидов 2 lvl могут заготовить 360 hp лечения в добрянике, или же обеспечивают пайками 360 бойцов (экипажи пары триер). Добряника портится через сутки, но я легко могу представить, как десятки и сотни корзин добряники доставляют на линию фронта с помощью "Teleportation_Circle" или "Transport_via_Plants" из друидских столиц. Ягоды крупные, около ~50 грамм (20 ягод на килограмм). Объём ягоды ~100 мл. В 100-литровой бочке 1000 ягод добряники, в корзине 100 ягод.  
