...
* "Святилище" (Hallow) — 17 эфес, 24 часа каста, 60-футовый радиус. Вечное. Существует пока не уберут "Рассеиванием магии" (Dispel_Magic). Зона становится запретной для: иномировых созданий, фей, элементалей, нежити. Всех, или любых на выбор заклинателя. Все люди, очарованные/подчинённые этими созданиями, избавляются от чужого влияния. "Святилище" нельзя нанести на корабль, только на неподвижную землю.
...
* "Чудо-ягоды" (Goodberry) — аптечки. За день до боя 12 друидов 2 lvl могут заготовить 360 hp лечения в добрянике, или же обеспечивают пайками 360 бойцов (экипажи пары триер). Добряника портится через сутки, но я легко могу представить, как десятки и сотни корзин добряники доставляют на линию фронта с помощью "Teleportation_Circle" из друидских столиц. Ягоды крупные, около ~50 грамм, объём ~100 мл. В 100-литровой бочке 1000 ягод добряники, в корзине 100 ягод.  
...
* "Подмога" (Aid) — на 3 существ, 8 часов действия, увеличивает число хитов и их максимум на 5 hp. Неплохое заклинание, чтобы поддержать офицеров в долгом сражении.
...
## 4 lvl — заклинания волшебника/чародея/варлока/барда (1 волшебник 7+ lvl на 640 000 населения)

* !!! "Магический глаз" (Arcane_Eye) — разведчик-невидимка. Видит не хуже человека (в оригинале на 30 футов). Может пройти через дюймовое отверстие. Летит на 30 футов/раунд, час концентрации = 3 мили полёта.
...
* !!! "Власть над водами" (Control_Water) — 300 футов, 10 минут концентрации. 100-футовый куб. Можно создать 50-футовый водоворот. Этим заклинанием можно затопить триеру, если капитан не выкинет спасбросок харизмы, если командует гребцами, или силы, если сам стоит за рулевым веслом.
* "Переносящая дверь" (Dimension_Door) — 500 футов дальности, только вербальный компонент. Можно взять другого.
* "Проклятье стихий" (Elemental_Bane) — 90 футов, минута концентрации, 2d6 урона/раунд, цель теряет сопротивляемость стихие.
...
* "Приватный кабинет" (Private_Sanctum) — 24 часа, 100-футовый куб. Защищён от заклинаний прорицания, телепортов, взгляда извне. Непроницаем для "Магического глаза". Можно сделать постоянным за год повторения заклинаний.
* "Отилюков упругий шар" (Resilent_Sphere) — минута концентрации, 10-футовая сфера. Спасбросок ловкости, если нацелена на врага. Сфера неуязвима и непроницаема для магии. Сфера ничего не весит, можно катить. Заклинание "Распад" (Disintegrate) разрушает сферу. Заклинание "Рассеивание магии" (Dispel_Magic) не может разрушить сферу.
...
* "Огненная стена" (Wall_of_Fire) — 120 футов, минута концентрации. Размеры стены 60x20x1 футов, либо круговая стена с радиусом 20 футов. Спасбросок ловкости, 5d8 урона всем, приблизившимся на 10 футов к опасной стороне стены. Обратная сторона стены урона не наносит.
...
* "Болезненное сияние" (Sickening_Radiance) — 120 футов, 10 минут концентрации, 30-футов радиус, спасбросок телосложения 4d10 урона, истощение.
...
## 4 lvl — заклинания жреца/друида/рейнджера/паладина (1 жрец 7+ lvl на 640 000 населения)

* "Защита от смерти" (Death_Ward) — 8 часов, спасает от смертельного удара, или эффекта любой формы, способного мгновенно убить.
...
## 5 lvl — заклинания волшебника/чародея/варлока/барда (1 волшебник 9+ lvl на 2 500 000 населения)
...
* +++ !!! "Призыв элементалей" (Conjure_Elemental) — 90 футов, 10 минут концентрации, минута каста. Призывает 6 элементалей (CR 5). Если концентрация нарушена, или эффект заклинания рассеян, элементали не исчезают, просто теряется контроль над ними.
...
* "Планарные узы" (Planar_Binding) — 17 эфесов, час каста, 24 часа действия (7 дней/6_круг, 30 дней/7_круг, 180 дней/8_круг, 360 дней/9_круг). Спасбросок харизмы, или цель подчинена заклинанием. Время призыва продлевается на время каста "Планарных уз". Все маги 13+ lvl имеют нескольких "планарных" слуг.
* "Ментальная связь" (Telepathic Bond) — ритуал, час действия. 8 существ. Неограниченная дальность связи.
...
* "Усиление навыка" (Skill Empowerment) — час концентрации. Удваивает бонус мастерства для выбранного навыка. Не может усилить навыки, бонус мастерства к которым уже удвоен.
...
* "Конус колода" (Cone_of_Cold) — 60-футовый конус, спасбросок телосложения, 8d8 урона. Превращает людей в ледяные статуи, но это не позволяет их реанимировать заклинанием 3 круга "Возрождение" (Revivify).
...
* "Рассвет" (Dawn) — 2 эфеса, 60 футов, минута концентрации, 30-футовый радиус. Спасбросок телосложения, 4d10 урона излучением. Луч света можно передвигать бонусным действием. Божественное заклинание, чтобы пылесосить ряды вражеской пехоты. Луч проходит до 600 футов/минуту.

## 5 lvl — заклинания жреца/друида/рейнджера/паладина (1 жрец 9+ lvl на 2 500 000 населения)
...
* "Заражение" (Contagion) — требует броска атаки, при попадании 7 дней действия. Цель делает спасброски телосложения каждый раунд. Три успеха — исцеление. Три провала — полные 7 дней болезни
...
* "Рассеивание добра и зла" (Dispel_Evil_and Good) — минута концентрации, помеха на атаки нежити и иномировых существ. Касание другого избавляет от очарование. Касание врага (с броском атаки) и спасброском харизмы, изгоняет его.
...
## 6 lvl — заклинания волшебника/чародея/варлока/барда (1 волшебник 11+ lvl на 5 000 000 населения)
...
* "Распад" (Desintegrate) — 60 футов, спасбросок ловкости, 10d6+40 урона. Убивая превращает тело в пыль. Уничтожает объекты 10-футового размера, или 10-футовый куб более крупного объекта.
* "Дромиджево появление" (Instant_Summons) — ритуал, 17 эфесов (сапфир). Объект до 10 фунтов и 6 футов по размеру. Предмет можно вызвать, уничтожив сапфир.
...
* "Плоть в камень" (Flesh_to_Stone) — 60 футов, минута концентрации, опутывание цели. Спасбросок телосложения. Три удачных спасброска завершают заклинание. Три провала превращают в камень.
...
* !!! "Волшебный сосуд" "Magic Jar" — 10 эфесов, минута каста, действует до рассеивания. Переносит душу кастера в сосуд, позволяет захватить бессознательное тело в 100 футах. Спасбросок харизмы. В сочетании с "Защитой от смерти" (Death_Ward) можно прежить уничтожение контейнера и навсегда остаться в новом теле.
...
* "Отилюков ледяной шар" (Freezing_Sphere) — 300 футов, 60-футовый радиус, спасбросок телосложения, 10d6 урона. Заморозка воды. Можно сохранить заклинание в "гранате" на 1 минуту. Можно передать эту "гранату" другому существу, например, призванной "громоптице", которая за минуту перенесёт заклинание на 3000 футов (1/2 мили), а затем сбросит на цель. Слава богам, что это заклинание доступно только волшебникам 11+ lvl, коих в мире всего лишь 20 человек, а в нашем регионе только один.
...
## 6 lvl — заклинания жреца/друида/рейнджера/паладина (1 жрец 11+ lvl на 5 000 000 населения)
...
* !!! "Путешествие через растения" (Transport_via_Plants) — раунд действия, до 25 человек успевают войти в дерево. Переносит их к другому дереву, которого когда-либо касался друид. Это подобие "Круга Телепортации" (Teleportation_Circle), очень близкое по эффективности к Телепорту 7 круга.
