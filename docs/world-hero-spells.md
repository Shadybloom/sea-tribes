...
* и минута действия, 2d6 урона излучением следующим ударом, делает невидимое существо видимым, цель светится слабым светом.
...
* !!! "Призыв низших демонов" (Summon_Lesser_Demons) — час концентрации. Этим заклинанием колдун может призвать слуг своего покровителя. Сильных слуг, в окружении сотни всякой мелочи. Считайте, что у вас всегда есть запасной отряд ополчения под рукой. Разумеется, «демоны» будут не из "Monsters_Manual". Можно призвать в сумме 12 CR демонов. То есть 12 чудовищ с CR 1, 24 твари с CR 1/2, 48 чертей с CR 1/4, или 96 бесят с CR 1/8. Можно совмещать: оптимальны отряды мелочи с сильным командиром.
...
* !!! "Призыв животных" (Conjure_Animals) — час концентрации. Это духи, принимающие форму животных. Считайте их запасным отрядом ополчения или слугами для всевозможных задач. Животных можно выбрать из "Monsters_Manual". Можно призвать в сумме 12 CR существ. То есть 12 чудовищ с CR 1, 24 зверюги с CR 1/2, 48 зверей с CR 1/4, или 96 зверят с CR 1/8. И таки да, можно призвать 12 гигантских орлов.
