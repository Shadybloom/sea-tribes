...
Снаряды пращи      | Глиняные, размером с яйцо. 1d4 dmg. Тяжёлые.    | 1000  | 1000     | 0.1
...
Стоимость заклинаний складывается из стоимости компонентов, работы мага, круга телепортации и послания. А для заклинаний 7 круга и выше из хотелок жрецов и волшебников, которых 13+ lvl единицы на мир.
...
Эти создания порабощены магией, к исходу срока заклинания они станут враждебны, если какое-то чудо не подружит вас.
...
--- | --------------------- | ------- | ------------------------------------------------------ |-------
1   | 1000 добряники        | 100     | Включает заказ и переброску телепортами к Коттаяму.    | 5
2   | Круг телепортации     | 100     | Переносит к другому постоянному "Кругу телепортации".  | 5
3   | Малое восстановление  | 100     | Плюс месяц заботы жрецов, рационы, постой при храме.   | 10
4   | Высшее восстановление | 1       | За день возвращает раненого в строй. С доставкой.      | 10
5   | Оживление             | 1       | Требуется цельное тело умершего менее 10 дней назад.   | 12
6   | Реинкарнация          | 1       | Достаточно части тела умершего менее 10 дней назад.    | 25
7   | Хождение по ветру*    | 10      | Включает "Круг телепортации" к друиду и возвращение.   | 25
8   | Пир героев*           | 100     | Это 2 часа работы жреца-кулинара 11+ lvl. 8 ритуалов.  | 150
...
№   | Созданный предмет      |  Заклинание          | Круг  | Свойства                     | Эфесов
--- | ---------------------- | -------------------- | ----- | ---------------------------- | ------
1   | Голосовое письмо       | Magic_Mouth          | 2     | До 25 слов.                  | 0.3
2   | Вечный светильник      | Continual_Flame      | 2     | Светит как факел.            | 1
3   | Волшебный сундук       | Arcane_Lock          | 2     | Пароль, +10 СЛ взлома.       | 2
4   | Охранные руны          | Glyph_of_Warding     | 3     | 10-футов сенсор. 20-фт взрыв | 5
5   | 30-футовая иллюзия     | Programmed_Illusion  | 6     | На 5 минут, по условию.      | 12
6   | Зона «Запрета»*        | Forbiddance          | 6     | Сильно ранит элементалей.    | 25
7   | Зона «Святилища»*      | Hallow               | 5     | Останавливает элементалей.   | 25
8   | Летающий меч*          | Animate_Objects      | 5     | Опаснее чем солдат-ветеран.  | 40
9   | Потайной сундук*       | Secret_Chest         | 4     | 0.4 кубометра. Призывается.  | 85
10  | Оживлённая статуя      | Animate_Objects      | 5     | Примитивное подобие голема.  | 250
11  | Приватный кабинет      | Private_Sanctum      | 4     | Прикрыт от наблюдения магией | 500
12  | Клетка для души        | Soul_Cage            | 6     | Не позволяет воскресить.     | 500
13  | Ковёр-самолёт*         | Animate_Objects      | 7     | 200 lb груза, 6 миль/час.    | 1000
14  | Ходячий дом (30x20 ft) | Animate_Objects      | 5     | Слабоват против баллист.     | 1500
15  | Круг телепортации*     | Teleportation_Circle | 5     | Постоянный, служит маяком.   | 1800
