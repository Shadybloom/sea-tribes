...
6   | Зона «Запрета»*        | 6     | Forbiddance          | Сильно ранит элементалей.    | 25
7   | Зона «Святилища»*      | 5     | Hallow               | Останавливает элементалей.   | 25
8   | Летающий меч*          | 5     | Animate_Objects      | Опаснее чем солдат-ветеран.  | 40
9   | Потайной сундук*       | 4     | Secret_Chest         | 0.4 кубометра. Призывается.  | 85
10  | Оживлённая статуя      | 5     | Animate_Objects      | Примитивное подобие голема.  | 250
11  | Приватный кабинет      | 4     | Private_Sanctum      | Прикрыт от наблюдения магией | 500
12  | Клетка для души        | 6     | Soul_Cage            | Не позволяет воскресить.     | 500
13  | Ковёр-самолёт*         | 7     | Animate_Objects      | 200 lb груза, 6 миль/час.    | 1000
14  | Ходячий дом (30x20 ft) | 5     | Animate_Objects      | Слабоват против баллист.     | 1500
15  | Круг телепортации*     | 5     | Teleportation_Circle | Служит маяком.               | 1800
