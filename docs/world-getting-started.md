...
Вот [шаблон карточки персонажа](/docs/world-hero-example.txt). Пользуйтесь, так будет лучше для всех.
...
- Опыт за сокровища. Каждый приобретённый тем или иным способом эфес приносит вам 25 exp. Воруйте, грабьте, продавайте награбленное и рабов. Или создавайте свою торговую империю. 1000 эфесов = 25000 exp.
