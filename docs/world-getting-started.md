...
Да, с помощью дипломатии вы можете получить в своё распоряжение героя 9+ уровня с многотысячной армией (разумеется, перед финальной битвой). Я обожаю раздавать неписей игрокам! В этом суть стратегического аспекта игры: найти союзников, создать коалицию — и выстоять перед грядущей бурей, до которой остаётся неполный год.  
