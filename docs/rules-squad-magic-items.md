...
-- | ------------------------- | ------------------------------------------------------ |----------
1  | Жезл безопасности*        | Переносит владельца в «Рай» на 200 дней.               |
   | Владелец: ???             | В этом месте нет старения. Повторно через 10 дней.     | 150 000
-- | ------------------------- | ------------------------------------------------------ |----------
2  | Шлем телепортации*        | Заклинание 7 круга «Телепортация». 3 заряда.           |
   | Владелец: ???             | Каждый день восстанавливает 1d3 заряда.                | 120 000
-- | ------------------------- | ------------------------------------------------------ |----------
3  | Посох леса*               | Заклинание 5 круга «Пробуждённый разум». 1 раз/день    |
   | Владелец: ???             | Без затрат компонентов это экономия 6000 эфесов/год    | 60 000
-- | ------------------------- | ------------------------------------------------------ |----------
4  | Амулет планов*            | Заклинание 7 круга «Уход в иной мир» (Plane_Shift)     |
   | Владелец: ???             | Требует броска ИНТ против СЛ 15. Иначе случайный выход | 50 000
-- | ------------------------- | ------------------------------------------------------ |----------
5  | Жезл правления*           | Очаровывает всех на 120 футов. Спасбросок мудр. СЛ 15. |
   | Владелец: ???             | Это очарование дикой силы, длительности и масштаба.    | 50 000
...
-- | ------------------------- | ------------------------------------------------------ |----------
1  | Флейта нереид             | Призывает водяного элементаля на сутки, 1 раз/день     |
   | Владелец: Дер-Кето        | Это водный змей, смышлёный и способный говорить.       | 2000
-- | ------------------------- | ------------------------------------------------------ |----------
2  | Сумка волшебных котов     | Призывает шестерых хранителей древнего Коттаяма,       |
   | Владелец: Тинв и Ри       | Они плуты и заклинатели, но совсем не любят воевать.   | 2000
-- | ------------------------- | ------------------------------------------------------ |----------
3  | Ветвь Первой оливы        | Хранит 1000 hp от любых лечебных заклинаний            |
   | Владелец: Акхен Ваджет    | Высвобождает касанием, но не больше 1 hp/раунд.        | 3000
-- | ------------------------- | ------------------------------------------------------ |----------
4  | Посох ударов*             | 10 зарядов. Восстанавливает 1d6+4 зарядов на рассвете. |
   | Владелец: Кумар Илионский | Также это оружие +3. Плюс 1d6 урона/заряд.             | 4000
-- | ------------------------- | ------------------------------------------------------ |----------
5  | Меч минувших дней*        | Каждое попадание вызывает «Sword_Burst» на 2d6 урона.  | 
   | Владелец: Карагос         | Также это оружие +2, а «Sword_Burst» не ранит своих.   | 5000
-- | ------------------------- | ------------------------------------------------------ |----------
6  | Кольцо телекинеза*        | Эффект заклинания «Телекинез» на 10 минут. 1 раз/сутки | 
   | Владелец: Накиями         | Кроме того неограниченный кантрип «Волшебная рука»     | 3000
-- | ------------------------- | ------------------------------------------------------ |----------
7  | Амулет щитостража*        | Конструкт с 17 AC, 142 hp и регенерацией 10 hp/раунд   |
   | Владелец: Крассиус Курио  | Принимает на себя 50% урона. Даёт +2 AC если рядом.    | 5000
-- | ------------------------- | ------------------------------------------------------ |----------
