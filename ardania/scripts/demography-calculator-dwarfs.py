...
# Уровень рождаемости (например: 0.03 значит 3%
# или 30 новорожденных на 1000 населения в год):
FERTILITY_RATE = 0.011
# Уровень смертности, аналогично:
MORTALITY_RATE = 0.0094
...
dict_population_ages['50-99'] = 0
dict_population_ages['100-149'] = 0
dict_population_ages['150-199'] = 0
dict_population_ages['200-249'] = 0
dict_population_ages['250-299'] = 0
dict_population_ages['300-349'] = 0
dict_population_ages['350-399'] = 0
dict_population_ages['400-449'] = 0
dict_population_ages['450-499'] = 0
for meta_key in sorted(metadict.keys()):
    if (metadict[meta_key]['age_real'] == 0):
        ...
        dict_population_ages['40-49'] = dict_population_ages['40-49'] + \
                metadict[meta_key]['generation_alive']
    elif (50 <= metadict[meta_key]['age_real'] <= 99):
        dict_population_ages['50-99'] = dict_population_ages['50-99'] + \
                metadict[meta_key]['generation_alive']
    elif (100 <= metadict[meta_key]['age_real'] <= 149):
        dict_population_ages['100-149'] = dict_population_ages['100-149'] + \
                metadict[meta_key]['generation_alive']
    elif (150 <= metadict[meta_key]['age_real'] <= 199):
        dict_population_ages['150-199'] = dict_population_ages['150-199'] + \
                metadict[meta_key]['generation_alive']
    elif (200 <= metadict[meta_key]['age_real'] <= 249):
        dict_population_ages['200-249'] = dict_population_ages['200-249'] + \
                metadict[meta_key]['generation_alive']
    elif (150 <= metadict[meta_key]['age_real'] <= 299):
        dict_population_ages['250-299'] = dict_population_ages['250-299'] + \
                metadict[meta_key]['generation_alive']
    elif (300 <= metadict[meta_key]['age_real'] <= 349):
        dict_population_ages['300-349'] = dict_population_ages['300-349'] + \
                metadict[meta_key]['generation_alive']
    elif (350 <= metadict[meta_key]['age_real'] <= 399):
        dict_population_ages['350-399'] = dict_population_ages['350-399'] + \
                metadict[meta_key]['generation_alive']
    elif (400 <= metadict[meta_key]['age_real'] <= 449):
        dict_population_ages['400-449'] = dict_population_ages['400-449'] + \
                metadict[meta_key]['generation_alive']
    elif (450 <= metadict[meta_key]['age_real'] <= 499):
        dict_population_ages['450-499'] = dict_population_ages['450-499'] + \
                metadict[meta_key]['generation_alive']
