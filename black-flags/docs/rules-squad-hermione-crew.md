...
Бойцов обучают [лейтенанты](/docs/rules-squad-lieutenants.md). Чем больше у вас лейтенантов, тем опытнее экипаж.  
...
- Экипаж обучается во время недели отдыха на берегу.
- При этом каждые 10k опыта превращаются в новых лейтенантов.
- Боцман придаёт этих лейтенантов отрядам и так прокачивает бойцов.
...
>Абордажная команда была разбита во время сражения за Ганг-и-Савай. Вы потеряли 30 человек, из которых 8 были лейтенантами. Вся наша история о том, как мы мучительно пытаемся воссоздать абордажников в былой славе, но на свой лад. Займёмся этим после начала игры.  

Состоит из опытных отделений во главе с лейтенантами. Они действуют единым отрядом, но могут и разделиться, чтобы сопровождать ваших героев в бою. Ниже несколько вариантов, они хорошо оптимизированы, сбалансированы друг с другом и проверены в десятках сражений. Используйте их как образцы для [карточки персонажа](/docs/world-hero-example.txt), перенеся в "Инвентарь".  
...
Снарядите их чем-нибудь "обычным" из [волшебных вещей](/docs/rules-squad-magic-items.md) в пределах доступных им эфесов и способностей, а простой [солдатской снарягой](/docs/rules-squad-weapon-and-armor.md) на свой вкус.  
...
Использование навыков разобрано в разделе "Действия героев" статьи о [морских сражениях](/docs/rules-squad-naval-battle.md). Здесь же сосредоточимся на грамотном абордаже и сухопутных боях.  
...
- В чистом поле лучшее решение — бросать всё тяжёлое и валить к кораблю. Пол-тысячи лучников (а они всегда лучники) превратят вас в ежей. Если невозможно — ставим дым и атакуем, целя в их главаря. Позади рассыпаем кальтропы, в сочетании с дымом они удержат врага.  
...
Вы можете тонко настроить поведение ИИ героя, как командира отряда, с помощью этого теста. Добавьте его в блок "ХАРАКТЕР" карточки персонажа. В начале игры я предлагаю это только боцману (и эта настройка будет работать только для отряда под его командованием, в том числе и если таковой включает все остальные). Что до остальных, в целом ваши отряды будут действовать как вы скажете — скажете оборонятся, будут обороняться, скажете наступать — будут наступать. Я стремлюсь к тому, чтобы все отряды (и ваши, и вражеские) в рамках правил DnD 5e сражались предельно эффективно, выжимая максимум из своих способностей и снаряжения. Чуда вы этой настройкой не сделаете, наши боевики и так хороши.  
