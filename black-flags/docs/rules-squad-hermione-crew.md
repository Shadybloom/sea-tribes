...
Когда палуба зачищена, эта победа. Не имеет значения, насколько силён враг и как много его осталось, через засыпанные кальтропами лестницы они уже не могут вырваться наверх, каждую такую попытку будут встречать градом пуль в упор и ударом десятка алебард. Тем временем ваши сапёры с топорами и пороховыми зарядами начнут работу, делая дыры в палубе и сбрасывая вниз картечные бомбы. Вскоре орудийная палуба будет зачищена, останется только кубрик и трюм. Если они там ещё не сдались, что же, можно поступить мягко — час окуривания серным дымом прекратит любое сопротивление. Всё же наша цель не в том, чтобы взрывчаткой разломать все припасы внизу.  
...
Объекты на поле боя загораживают обзор. Любой объект закрывает обзор от 10% до 50%, это нарастающий штраф.

Например, длина борта Фэнси, это 125 футов, 25 тайлов. Первые 25 стрелков у борта будут стрелять точно, для второго ряда цель имеет укрытие на 1/2 +2 AC, для третьего ряда укрытие на 3/4 +5 AC, для четвёртого ряда цель не видна вовсе. Чтобы не мешать следующему ряду, стрелки после выстрела становятся на колено, так уменьшая штраф до минимальных 10%. Для стрелка с Feat_Sharpshooter укрытия несущественны, пока цель хоть насколько-то видна.

Дым и туман Fog_Cloud также, подобно укрытиям, загораживает обзор, плюс к тому накладывает помеху на все атаки. Один тайл дыма снижает видимость на 50%, два тайла на 100%. Фактически, в дыму бойцы кое-как видят только до 10 футов, а цель в 5 футах от них уже получает +2 AC, цель в 10 футах +5 AC. Fighting_Style_Blind_Fighting решает эту проблему для бойцов ближнего боя, Feat_Sharpshooter для стрелков. Но за более чем 10-футовым облаком дыма цель в любом случае не видна.

Если цель не видна, в неё нельзя стрелять прицельно. Можно только целиться куда-то туда в облако, делая атаки без бонусов к атаке и урону от способностей стрелка. Есть смысл стрелять только толпой.

### Высоты

>На трёх мачтах Фэнси есть марсовые площадки (высота их 50 футов). На каждом вороньем гнезде можно разместить 4 стрелка. Всего до 12 снайперов.

Высоты дают линию взгляда на цель за укрытиями. Такими как фальшборт корабля, осадные щиты, или спины солдат в строю. Каждый боец получает пользу только от укрытия того тайла, на котором он находится, но не от остальных укрытий по линии взгляда. От взгляда с высоты полностью закрывает только полное укрытие на тайле бойца.
